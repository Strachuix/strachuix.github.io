...
const translations = {
  ...
  pl: {
    ...
    EPrescriptionDescription:
      ...
      "Wystawienie e-recepty przez lekarza na lek stosowany doraźnie po krótkiej konsultacji online. Szybka pomoc w nagłych sytuacjach.",

    ECertificate: "E-zaświadczenie",

    ECertificateDescription:

      "Zaświadczenie L1 to dokument lekarski potwierdzający stan zdrowia do uczestnictwa w zajęciach, pracy, wyjazdach czy aktywnościach fizycznych.",
    ...
    EReferralDescription:
      ...
      "E-skierowanie umożliwiające szybkie wykonanie prywatnych badań diagnostycznych, konsultacji specjalistycznych lub rozpoczęcie leczenia. Priorytetowo - na CITO - np. RTG, MRI, czy TK.",

    Teleconsultation: "E - konsultacja",

    TeleconsultationDescription:

      "Kompleksowa konsultacja podczas w ramach której lekarz może stwierdzić: niezdolność do pracy, wystawić zaświadczenie, zaordynować wymagane leczenie, wystawić e-receptę i e-skierowanie.",

    InternalConsultation: "Konsultacja internistyczna",

    InternalConsultationDescription: "Porada od lekarza pierwszego kontaktu.",

    ContraceptivePills: "Antykoncepcja kontynuacja (E-Recepta)",

    ContraceptivePillsDescription: "E-recepta na antykoncepcję hormonalną dla pacjentek stosujących wcześniej tę metodę.",

    MorningAfterPill: 'Antykoncepcja "tabletka dzień po"',

    MorningAfterPillDescription:

      "Szybka konsultacja i e-recepta na antykoncepcję awaryjną w nagłych sytuacjach.",

    TreatmentContinuation: "Kontynuacja leczenia (E-Recepta)",
    ...
    OrtoConsultation: "Konsultacja ortopedyczna",

    OrtoConsultationDescription:
    
      "Zdalna konsultacja ortopedyczna z omówieniem dolegliwości i dalszych kroków leczenia.",

    Interpretation: "Interpretacja wyników badań",

    InterpretationDescription: 
    
      "Omówienie wyników badań laboratoryjnych wraz z zaleceniami lekarskimi.",
